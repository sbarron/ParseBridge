...
+ (void)initializeJava
{
	...
	BOOL method2 = [ParseObject registerInstanceMethod:@"saveEventually"
    ...
    BOOL method4 = [ParseObject registerInstanceMethod:@"put"
    ...
    BOOL method5 = [ParseObject registerStaticMethod:@"create"
    ...
    BOOL method6 = [ParseObject registerStaticMethod:@"saveAll"
